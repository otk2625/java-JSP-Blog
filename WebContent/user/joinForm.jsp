...
<div class="container">
	<form action="/blog/user?cmd=join" method="post"
		onsubmit="return valid()"> <!-- onsubmit 데이터의 유효성을 체크 -->
...
<script>
	...
	function usernameCheck() {
		...
		var username = $("#username").val(); // id가 username인걸 찾아서 value값을 찾는다.
		$.ajax({
			type : "POST",
		...
		}).done(function(data) { //원래 있는 빌더패턴 같은것 여기서 response.getWriter로 값을 전달받음
